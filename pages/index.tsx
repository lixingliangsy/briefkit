  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://briefkit.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is BriefKit?", "acceptedAnswer": {"@type": "Answer", "text": "A brief tool that turns a keyword or URL into outline, PAA questions, sources, and a GEO answer hook."}}, {"@type": "Question", "name": "What is in the brief?", "acceptedAnswer": {"@type": "Answer", "text": "H2/H3 outline, people-also-ask questions, authority sources, and an AI-answer hook."}}, {"@type": "Question", "name": "How does it help GEO?", "acceptedAnswer": {"@type": "Answer", "text": "It structures content to be citable by answer engines, not only ranked in classic search."}}, {"@type": "Question", "name": "Can I use a competitor URL?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Paste a URL to reverse-build a brief from that page’s structure."}}, {"@type": "Question", "name": "Who is it for?", "acceptedAnswer": {"@type": "Answer", "text": "Content and SEO teams writing for search and LLM citation."}}, {"@type": "Question", "name": "Does it guarantee rankings?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is a writing plan — you still add firsthand value."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">BriefKit - definition</h2>
